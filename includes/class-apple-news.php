...
class Apple_News {
	...
	public function action_enqueue_block_editor_assets() {
		...
		if ( 
			isset( Admin_Apple_Settings_Section::$loaded_settings['post_types'] ) &&
			! in_array( get_post_type(), (array) Admin_Apple_Settings_Section::$loaded_settings['post_types'], true ) ) {
			return;
		}
